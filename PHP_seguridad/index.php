...
<body>
    <h1>Limpiar y validar contenido insertado en el formulario</h1>
...
<form action="recibir_contenido.php" method="get">
    ...
    <label for="texto">Inserte un Comentario de texto</label>
