...
// 3. MOSTRAR DATOS ------------------------------------
    ...
    foreach($datos as $ficha){
        echo '<li>';
        echo '<a href="ficha.php?nombre_ficha='.$ficha['nombre'].'&archivo_json='.$archivoJSON.'">';
      ...
      //  echo '<p><span>Dato2:</span>'.$ficha['dato2'].'</p>';
        echo '</a>';
        echo '<a class="btn" href="ficha.php?nombre_ficha='.$ficha['nombre'].'&archivo_json='.$archivoJSON.'">Ver ficha</a>';
        echo '</li>';
    }
    echo '</ul>';
?>
